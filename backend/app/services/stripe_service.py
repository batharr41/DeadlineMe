...
async def create_stake_payment(amount: int, user_id: str, user_email: str) -> dict:
    ...
    intent = stripe.PaymentIntent.create(
        ...
        metadata={"user_id": user_id, "user_email": user_email, "type": "deadline_stake"},
...
async def cancel_stake_with_forfeit(payment_intent_id: str) -> dict:
    """Alias for partial_refund_stake at 50%."""
    return await partial_refund_stake(payment_intent_id, 0.5)
...
async def process_failed_stake(payment_intent_id: str, anti_charity_id: str) -> dict:
    ...
    return {"captured": True, "anti_charity_id": anti_charity_id, **capture_result}